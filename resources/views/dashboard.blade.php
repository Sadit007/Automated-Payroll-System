...
<body>
    <div class="d-flex" >
        ...
        <div class="flex-grow-1 p-4">
            ...
            <p>What would you like to today?</p>
            <div class="card mt-4">
                <div class="card-body">

                        <div class="container-fluid">
                            <div class="row ">
                                <div class="col-md-2 mb-3 d-flex flex-column align-items-center text-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-receipt-cutoff" viewBox="0 0 16 16">
                                    ...
                                    <p style="color: black;" >Create Invoice</p>                                
                                </div>
                                ...
                                <div class="col-md-2 mb-3 d-flex flex-column align-items-center text-primary">
                                    ...
                                    <p style="color: black;">Pay Bills</p>
                                </div>
                                ...
                                <div class="col-md-2 mb-3 d-flex flex-column align-items-center text-primary">
                                    ...
                                    <p style="color: black;">Run Payroll</p>
                                </div>
